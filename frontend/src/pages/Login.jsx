    ...
    <div className="min-h-screen bg-white grid lg:grid-cols-2">
      <div className="hidden lg:flex flex-col justify-between p-12 bg-neutral-900 text-white">
        ...
        <div className="max-w-md">
          ...
          <p className="text-[15px] text-neutral-400 mt-4 leading-relaxed">Ferramentas e apps que se conectam à sua loja em minutos. Stories, avaliações, pop-ups e mais — sem complicação.</p>
        </div>
      ...
      <div className="flex items-center justify-center p-8">
        <form onSubmit={submit} className="w-full max-w-sm">
          ...
          <Input type="email" required defaultValue="contato@vitrinneclassica.com" className="h-11 rounded-xl border-neutral-200 mb-4"/>

          <label className="text-[13px] font-medium text-neutral-700 block mb-1.5">Senha</label>
          <div className="relative mb-2">
            <Input type={show?"text":"password"} required defaultValue="••••••••" className="h-11 rounded-xl border-neutral-200 pr-10"/>
          ...
          <div className="flex justify-end mb-7">
            <Link to="/forgot-password" className="text-[13px] text-neutral-600 hover:text-neutral-900 hover:underline">Esqueceu a senha?</Link>
          </div>

          <button type="submit" className="w-full h-11 rounded-xl bg-neutral-900 text-white text-[14.5px] font-medium hover:bg-neutral-800 transition-colors">
            Entrar
          </button>
